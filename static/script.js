...
const populateBotResponse = async (userMessage) => {
  ...
  if (isFirstMessage) {
    response = { botResponse: "Greetings! As your trusty data assistant, I'm here to assist with any inquiries you may have about your data. Please feel free to upload the PDF file you'd like me to analyze."};
    uploadButtonHtml = `
